                                    ...
                                    switch (Console.ReadLine())
                                    {
                                        ...
                                        case "2":
                                            ...
                                            case "4": 
                                            {
                                                ...
                                                Console.WriteLine("Введите EMAIL получателя сообщения.");
                                                messageData.Email = Console.ReadLine();

                                                Console.WriteLine("Введите текст сообщения, обратите внимание, что сообщение" +
                                                    "не может быть пустым, а так же не может превышать 5000 символов.");
